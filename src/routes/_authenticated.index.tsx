...
function DashboardPage() {
  ...
  const filteredCompanies = useMemo(() => {
    ...
    if (quickFilter === "active") {
      ...
      filtered = filtered.filter((c) => !c.ad01_filing_date && (!c.auth_code || c.auth_code.trim() === "" || c.auth_code.trim().toLowerCase() === "pending"));
    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        const segments = [
          ...
          { key: "ad01", label: "AD01 Pending", count: owned.filter((c) => !c.ad01_filing_date && (!c.auth_code || c.auth_code.trim() === "" || c.auth_code.trim().toLowerCase() === "pending")).length },
