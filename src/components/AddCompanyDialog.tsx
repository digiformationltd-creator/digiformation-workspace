  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-lg w-[calc(100vw-2rem)] max-h-[90vh] overflow-y-auto">
        ...
        {/* System-derived (read-only) — these values are owned by the database trigger */}
        <div className="rounded-lg border bg-muted/40 p-3 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div>
              ...
              <p className="font-semibold">{friendlyCategory}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-semibold text-muted-foreground/80 italic">derived on save</p>
            </div>
            <div>
          ...
          <p className="text-[10px] text-muted-foreground/70">
            You only enter raw facts. The database derives category, status, ready-to-sell and address match automatically.
          </p>
        </div>
